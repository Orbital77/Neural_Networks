...
void set_values(double input[][bound], double biases[], double w[][bound], int n_neurons, int n_p_neurons, N_Layer *layer)
{
	int input_r = sizeof(layer->input) / sizeof(layer->input[0]);
	int input_c = sizeof(layer->input[0]) / sizeof(layer->input[0][0]);

	int weights_r = sizeof(layer->weights) / sizeof(layer->weights[0]);
	int weights_c = sizeof(layer->weights[0]) / sizeof(layer->weights[0][0]);
